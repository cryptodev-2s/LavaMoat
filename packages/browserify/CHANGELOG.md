...
## [20.0.8](https://github.com/LavaMoat/LavaMoat/compare/lavamoat-browserify-v20.0.7...lavamoat-browserify-v20.0.8) (2026-09-21)
...
* The following workspace dependencies were updated
  * dependencies
    * @lavamoat/lavapack bumped from ^9.0.0 to ^9.0.1
    * lavamoat-core bumped from ^18.0.6 to ^19.0.0
  * devDependencies
    * lavamoat bumped from 11.1.5 to 11.1.6

## [20.0.7](https://github.com/LavaMoat/LavaMoat/compare/lavamoat-browserify-v20.0.6...lavamoat-browserify-v20.0.7) (2026-09-03)
...
* The following workspace dependencies were updated
  * dependencies
    * @lavamoat/lavapack bumped from ^8.0.5 to ^9.0.0
    * lavamoat-core bumped from ^18.0.5 to ^18.0.6
  * devDependencies
    * lavamoat bumped from 11.1.4 to 11.1.5

## [20.0.6](https://github.com/LavaMoat/LavaMoat/compare/lavamoat-browserify-v20.0.5...lavamoat-browserify-v20.0.6) (2026-06-25)
...
* The following workspace dependencies were updated
  * dependencies
    * @lavamoat/lavapack bumped from ^8.0.4 to ^8.0.5
    * lavamoat-core bumped from ^18.0.4 to ^18.0.5
  * devDependencies
    * lavamoat bumped from 11.1.3 to 11.1.4
